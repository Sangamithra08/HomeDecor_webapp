              ...
              <div className="card-body py-0 px-0 px-sm-3">
                <div className="row align-items-center">
                  <div className="col-4 col-sm-3 col-xl-2">
                    <img src={require('../Assests/Img/img1.png')} className="gradient-corona-img img-fluid" alt="banner" />
                  </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="d-flex">
                            <img src={require('../Assests/Img/img1.png')} alt="face" />
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="preview-list">
                  <div className="preview-item border-bottom">
                    <div className="preview-thumbnail">
                      <img src={require('../Assests/Img/img1.png')} alt="face" className="rounded-circle" />
                    </div>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <Slider className="portfolio-slider" {...this.sliderSettings}>
                  <div className="item">
                    <img src={require('../Assests/Img/img1.png')} alt="carousel-item" />
                  </div>
                  <div className="item">
                    <img src={require('../Assests/Img/img1.png')} alt="carousel-item" />
                  </div>
                ...
                <div className="d-flex py-4">
                  <div className="preview-list w-100">
                    <div className="preview-item p-0">
                      <div className="preview-thumbnail">
                        <img src={require('../Assests/Img/img1.png')} className="rounded-circle" alt="face" />
                      </div>
                      <div className="preview-item-content d-flex flex-grow">
                        <div className="flex-grow">
                          <div className="d-flex d-md-block d-xl-flex justify-content-between">
